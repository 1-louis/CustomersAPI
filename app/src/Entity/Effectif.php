...
class Effectif
{
     ...
     * @Groups({"Effectif:readE","Effectif_details_read"})
     *
     */
    private $CIVILITE;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Customers::class, inversedBy="effectifs_id")
     * @Groups({"readE","Effectif_details_read"})
     */
    private $Effec_id;
    ...
    public function getEffecId(): ?Customers
    {
        return $this->Effec_id;
    }

    public function setEffecId(?Customers $Effec_id): self
    {
